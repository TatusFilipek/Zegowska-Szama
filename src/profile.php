...
<?php require_once __DIR__ . '/header.php'; ?>
    ...
    <div class="flex-fill container-fluid px-4 py-3 overflow-auto d-inline d-md-none">
        ...
        <div class="mb-5">
            <h3 class="display-6 border-bottom pb-2" style="color: #4a5568; border-color: #4a5568 !important; font-weight: 300;">Information</h3>
        ...
        <div class="mb-4">
            <h3 class="display-6 border-bottom pb-2" style="color: #4a5568; border-color: #4a5568 !important; font-weight: 300;">Settings</h3>
            
            <div class="row mt-3 py-2 fs-5 align-items-center">
                <div class="col-2 text-muted">Theme:</div>
                <div class="col-10">
            ...
            <div class="text-center mx-auto" style="width: 100%;">
                ...
                <div class="d-flex justify-content-center gap-5">
                    ...
                    <h1 class="display-1 fw-bold promo-text py-4 m-0 mx-3">
                        About <span class="accent-text">you</span> ...
                    </h1>
                </div>
            </div>
        </div>
